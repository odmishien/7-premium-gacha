  ...
  $('#gacha-button').on('click',function(e) {
    ...
    $.ajax({
      ...
      for(let product of products) {
        ...
        products_text_for_twitter = products_text_for_twitter + product.ProductName + ' ' +  product.PriceWithTax + '円\n'
      }

      products_text_for_twitter = products_text_for_twitter + '合計' + total_with_tax + '円'
